  ...
  return (
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
      <div className="lg:col-span-5 space-y-4 hidden lg:block pr-2">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brand/10 dark:bg-brand/20 border border-brand/20 dark:border-brand/30 text-brand dark:text-[#7b9bee] text-xs font-bold uppercase tracking-wider">
        ...
        <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed max-w-md">
          Đăng ký tài khoản miễn phí để nhận ngay 1 bài test kiểm tra đầu vào,
          lộ trình ôn tập cá nhân hóa và làm quen với đề thi chuẩn quốc tế.
        </p>
        ...
        <div className="space-y-2.5 pt-1">
          ...
          <div className="flex items-start gap-2.5">
            <div className="w-6 h-6 rounded-lg bg-brand/10 text-brand dark:text-[#7b9bee] flex items-center justify-center shrink-0 mt-0.5">
              <CheckCircle2 className="size-3.5" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-slate-900 dark:text-white">
              ...
              <p className="text-[11px] text-slate-500 mt-0.5">
                Đồng hồ đếm ngược server, tự động lưu câu trả lời và bảng điểm
                quy đổi chuẩn.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 mt-0.5">
                Giúp bạn khắc phục bẫy đề thi và các lỗi sai ngữ pháp cho đến
                khi làm chủ hoàn toàn.
              </p>
            </div>
          </div>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleSendOtp} className="space-y-3.5">
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <Input
                      ...
                      className="pl-10! pr-3.5! h-10.5 rounded-xl text-xs sm:text-sm bg-slate-50/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus:border-brand focus:ring-2 focus:ring-brand/20"
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <Input
                        ...
                        placeholder="••••••••"
                        className="pl-10! pr-10! h-10.5 rounded-xl text-xs sm:text-sm bg-slate-50/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus:border-brand focus:ring-2 focus:ring-brand/20"
                      />
                      <button
                        type="button"
                ...
                <div className="pt-0.5">
                  <label className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-400 cursor-pointer select-none">
                    <input
                      ...
                      className="size-4 mt-0.5 rounded-md border-slate-300 dark:border-slate-700 text-brand focus:ring-brand cursor-pointer shrink-0"
                    />
                    <span>
                      Tôi đồng ý với{" "}
                      <Link
                        href="/terms"
                        className="text-brand dark:text-[#7b9bee] font-bold hover:underline"
                      >
                        Điều khoản
                      </Link>{" "}
                      và{" "}
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-11 rounded-xl font-bold text-sm bg-brand hover:bg-[#1e2f5e] text-white shadow-md shadow-brand/20 hover:shadow-lg hover:shadow-brand/30 transition-all cursor-pointer flex items-center justify-center gap-2 mt-1"
                >
                  {loading ? (
                    <>
          ...
          {step === "otp" && (
            <>
              ...
              <div className="flex justify-center py-3">
                <div className="w-16 h-16 rounded-2xl bg-brand/10 text-brand dark:text-[#7b9bee] flex items-center justify-center">
              ...
              <form onSubmit={handleRegisterWithOtp} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="• • • • • •"
                    className="h-14 rounded-xl text-2xl text-center tracking-[0.5em] font-bold bg-slate-50/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus:border-brand focus:ring-2 focus:ring-brand/20"
                  />
                </div>
                <div className="text-center">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="text-xs font-bold text-brand dark:text-[#7b9bee] hover:underline disabled:opacity-50"
                  >
                    Gửi lại OTP
                  </button>
                </div>
                ...
                <Button
                  ...
                  className="w-full h-11 rounded-xl font-bold text-sm bg-brand hover:bg-[#1e2f5e] text-white shadow-md shadow-brand/20 hover:shadow-lg hover:shadow-brand/30 transition-all cursor-pointer flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
                      <span className="h-4 w-4 rounded-full border-2 border-white/30 border-t-white animate-spin" />
