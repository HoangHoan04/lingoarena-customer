...
interface AptisQuestionGridProps {
  questions: AptisQuestion[];
  currentIndex: number;
...
export function AptisQuestionGrid({
  questions,
  currentIndex,
  answers,
  flaggedIds,
  ...
  const groupedParts = useMemo(() => {
    const groups: {
      partNumber: number;
      partTitle: string;
      items: { q: AptisQuestion; originalIdx: number }[];
    }[] = [];
