...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden pt-6 pb-16 lg:py-16">
      {/* Background Glows */}
      <div className="pointer-events-none absolute -top-24 left-1/2 -z-10 h-125 w-200 -translate-x-1/2 rounded-full bg-linear-to-tr from-brand/15 via-[#4563b0]/10 to-brand/15 blur-3xl dark:from-brand/20 dark:via-[#7b9bee]/15 dark:to-brand/20" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            {/* Top Micro-badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand/10 dark:bg-brand/20 border border-brand/20 dark:border-brand/30 shadow-2xs backdrop-blur-xs">
              <Sparkles className="size-4 text-brand dark:text-[#7b9bee] animate-pulse" />
              <span className="text-xs font-bold uppercase tracking-wider text-brand dark:text-[#7b9bee]">
                {t("badge")}
              </span>
            </div>
                ...
                {(["TOEIC", "IELTS", "VSTEP", "APTIS"] as const).map((exam) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all duration-300 cursor-pointer ${
                      selectedExam === exam
                        ? "bg-brand text-white dark:bg-white dark:text-brand shadow-md scale-105"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              <Button
                size="lg"
                className="w-full sm:w-auto px-8 py-6 rounded-2xl font-bold text-base shadow-xl shadow-brand/25 hover:shadow-brand/40 hover:scale-[1.02] transition-all bg-brand hover:bg-[#1e2f5e] text-white cursor-pointer"
              ...
              >
                <PlayCircle className="size-5 text-brand dark:text-[#7b9bee]" />
                {t("ctaExplore")}
              </Button>
            </div>
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs text-slate-500 dark:text-slate-400">
              ...
              <span className="flex items-center gap-1.5 font-medium">
                <Bot className="size-4 text-brand dark:text-[#7b9bee]" /> AI Writing & Speaking Rubric
              </span>
              <span className="flex items-center gap-1.5 font-medium">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute -inset-1 rounded-3xl bg-linear-to-r from-brand via-[#405ea7] to-brand opacity-20 blur-xl dark:opacity-30" />
            ...
            <div className="relative rounded-3xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800 shadow-2xl p-6 sm:p-8 space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
                ...
                <Badge variant="secondary" className="bg-brand/10 dark:bg-brand/20 text-brand dark:text-[#7b9bee] font-semibold border-brand/20 dark:border-brand/30">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-4 border border-slate-100 dark:border-slate-700/50">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <div className="text-xs font-medium text-slate-500">
                    <span className="font-bold text-brand dark:text-[#7b9bee]">94.8% Reliability</span>
                  </div>
                </div>
                {/* Progress bar */}
                <div className="w-full bg-slate-200 dark:bg-slate-700 h-2 rounded-full overflow-hidden mt-3">
                  <div className="bg-linear-to-r from-brand to-[#4563b0] h-full w-[82%] rounded-full animate-pulse" />
                </div>
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {currentHighlight.skills.map((skill, idx) => (
                    ...
                    >
                      <CheckCircle2 className="size-4 text-brand dark:text-[#7b9bee] shrink-0" />
                      <span>{skill}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2 overflow-hidden">
                    <div className="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-slate-900 bg-brand text-[10px] text-white font-bold text-center leading-6">A</div>
                    ...
                    <div className="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-slate-900 bg-brand-dark text-[10px] text-white font-bold text-center leading-6">L</div>
                  </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mt-16 pt-8 border-t border-slate-200/60 dark:border-slate-800">
          <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xs p-5 rounded-2xl border border-slate-200/60 dark:border-slate-800 text-center sm:text-left flex flex-col sm:flex-row items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-brand/10 text-brand dark:text-[#7b9bee] flex items-center justify-center shrink-0">
