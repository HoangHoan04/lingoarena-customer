  ...
  const highlights = [
    {
      ...
      description:
        "50,000+ official questions strictly following TOEIC ETS, Cambridge IELTS, and VSTEP formats.",
    },
    {
      icon: Sparkles,
      title: "Personalized AI Pathways",
      description:
        "Adaptive algorithms automatically target weaknesses and optimize your daily study hours.",
    },
    {
      icon: Clock,
      title: "Spaced Repetition (SRS)",
      description:
        "Scientifically proven memory methodology to permanently remember thousands of vocabulary words.",
    },
    {
      icon: Users,
      title: "IELTS 8.5+ Instructors",
      description:
        "Experienced educators evaluating Writing and Speaking according to international rubrics.",
    },
  ];
          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xs text-left">
                <div className="text-2xl sm:text-3xl font-black text-brand dark:text-[#7b9bee]">
                  {t("stat1Number")}
                </div>
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {highlights.map((item, idx) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-brand/10 dark:bg-brand/20 text-brand dark:text-[#7b9bee] flex items-center justify-center">
