  ...
  return (
    <section className="py-16 sm:py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl sm:rounded-4xl overflow-hidden bg-linear-to-r from-brand-dark via-brand to-brand-dark text-white p-8 sm:p-12 lg:p-16 shadow-2xl border border-brand/40 text-center space-y-8">
          <div className="pointer-events-none absolute -top-32 left-1/2 z-0 h-96 w-96 -translate-x-1/2 rounded-full bg-brand/40 blur-3xl" />
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-sm sm:text-base text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Hãy bắt đầu hành trình học tập của bạn với LingoArena và trải
              nghiệm sự khác biệt ngay hôm nay!
            </p>
          </div>
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <Button
              size="lg"
              className="w-full sm:w-auto px-10 py-6 rounded-2xl font-extrabold text-base bg-white text-brand hover:bg-slate-100 shadow-xl shadow-black/20 hover:scale-105 transition-all cursor-pointer"
          ...
          <div className="relative z-10 pt-4 flex flex-wrap items-center justify-center gap-6 text-xs text-slate-300">
            <span className="flex items-center gap-1.5">
              <ShieldCheck className="size-4 text-emerald-400" /> 100%
              Guaranteed Results
            </span>
            <span className="flex items-center gap-1.5">
              <Sparkles className="size-4 text-[#a0baff]" /> Instant
